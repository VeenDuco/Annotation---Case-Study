...
finalMatrix  <- foreach(i = 1:reps, .packages = c("rstan", "tcltk"), 
                        ...
                        .verbose = TRUE) %dopar% {
                          ...
                          tempMatrix <- matrix(NA, ncol = (sim.data$J + sim.data$J + 1), nrow = 1)
...
pdf(paste0("SIMULATIONS/RESULTS/FIGURES/raykar_reduced_to_Dawid_Skene", 
...
save.image(paste0("SIMULATIONS/RESULTS/IMAGES/raykar_reduced_to_Dawid_Skene", 
                  "I", sim.data$I, "J", sim.data$J, "D", sim.data$D, 
                  "missing", sim.data$missing * 100, 
                  "Bins", bins, "replications", reps, ".rdata"))

saveRDS(finalMatrix, paste0("SIMULATIONS/RESULTS/finalMatrixRDS/raykar_reduced_to_Dawid_Skene", 
                            "I", sim.data$I, "J", sim.data$J, "D", sim.data$D, 
                            "missing", sim.data$missing * 100, 
...
writeLines(capture.output(sessionInfo()), 
           paste0("SIMULATIONS/RESULTS/SESSIONINFO/raykar_reduced_to_Dawid_Skene", 
                  "I", sim.data$I, "J", sim.data$J, "D", sim.data$D, 
                  "missing", sim.data$missing * 100, 
